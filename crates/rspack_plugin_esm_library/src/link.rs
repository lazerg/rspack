...
use rspack_core::{
  ...
  NAMESPACE_OBJECT_EXPORT, RuntimeGlobals, SideEffectsStateArtifact, SourceType, URLStaticMode,
  UsageState, UsedName, UsedNameItem, escape_name_atom_ref, find_new_name, find_target,
